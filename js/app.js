// API url
const urlnomis = [
  'https://www.nomisweb.co.uk/api/v01/dataset/NM_618_1.data.tsv?date=latest&geography=TYPE298&rural_urban=0&cell=',
...
function makeLayers() {
  ...
  map.addLayer({
    ...
    'paint': {
      'fill-extrusion-height': ['*', ['feature-state', 'value'], 100],
